...
use hal::{clock::ClockControl, peripherals::Peripherals, prelude::*, Delay, IO, timer::TimerGroup, embassy, gpio::{Output, PushPull, Gpio4, Gpio3, Input, PullUp, Gpio5}};
...
#[embassy_executor::task]
async fn rotary(pin_a: Gpio4<Input<PullUp>>, pin_b: Gpio5<Input<PullUp>>) {
...
fn main() -> ! {
    ...
    executor.run(|spawner| {
        ...
        spawner.spawn(rotary(pin4, pin5)).unwrap();
